...
namespace Helper
{
    ...
    {
        // public AccessDB() { }
        public AccessDB(string accesspath)
        {
            this.ConnStr = accesspath;
        }
        ...
        public System.Data.DataTable GetTable(string sql, params System.Data.IDataParameter[] p)
        {
            ...
            using (OleDbConnection conn = GetConn())
            {
                ...
                if (p != null)
                    cmd.Parameters.AddRange(p);
                OleDbDataAdapter sdap = new OleDbDataAdapter(cmd);
                sdap.Fill(dt);
            }
            return dt;
        }
        ...
        public OleDbType ConvertType(string type)
        {
